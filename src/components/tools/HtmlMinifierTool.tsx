...
const HtmlMinifierTool = () => {
  ...
  return (
    <div className="space-y-4">
      <Textarea placeholder="Paste HTML code here..." value={input} onChange={e => setInput(e.target.value)} rows={8} className="font-mono text-sm" />
      {input && (
        <>
          ...
          <div className="rounded-lg bg-muted p-4">
            <div className="flex items-center justify-between mb-2">
              <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider">Minified HTML</p>
